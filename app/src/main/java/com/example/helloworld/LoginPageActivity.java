...
public class LoginPageActivity extends AppCompatActivity implements View.OnClickListener, Serializable {
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.join_button){
            ...
            delayHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                   final Intent  intent = new Intent(LoginPageActivity.this, MainPage.class);
                    startActivity(intent);
                }
            }, 500);
